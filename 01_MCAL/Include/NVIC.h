...
/************************************************Defines*************************************************/
  ...
  * @brief  : These options represents the number of the last bit the Sub-Priority Group
 ...
 *            of the specific Microcontroller you are working with to get more details about the IRQs used in the chip.
 */
 ...
 * @param   : A pointer of type uint32_t to assign the priority value in it, the value is one of the above options (The number of the sub-priority bit)
 * @return  : It returns a variable of type enuErrorStatus_t with "enuErrorStatus_Ok" of value if the Operation was Successful
 * @note    : Please note that this is a Generic Driver for ARM Cortex-M(3,4) Processors, so you must refer to the datasheets
 *            of the specific Microcontroller you are working with to get more details about the IRQs used in the chip.
 */
